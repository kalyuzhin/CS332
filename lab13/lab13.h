...
namespace lab13 {
    ...
    void stbi_set_flip_vertically_on_load(bool b);

    unsigned char *stbi_load(const char *str, int *pInt, int *pInt1, int *pInt2, int i);

    void stbi_image_free(unsigned char *data);
