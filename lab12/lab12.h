...
namespace lab12 {
    ...
    private:
        ...
        ModelData tetrahedronData() {
            return {
                {
                    -0.5f, -0.5f, -0.5f,  1.0f, 0.0f, 0.0f,  // Вершина 0: красная
                     0.5f, -0.5f, -0.5f,  0.0f, 1.0f, 0.0f,  // Вершина 1: зеленая
                     0.0f,  0.5f, -0.5f,  0.0f, 0.0f, 1.0f,  // Вершина 2: синяя
                     0.0f,  0.0f,  0.5f,  1.0f, 1.0f, 1.0f   // Вершина 3: белая
                },
                {
